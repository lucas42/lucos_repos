...
func init() {
	Register(Convention{
		ID:          "container-naming",
		Description: "Every container_name set in docker-compose.yml (test-profile services excluded) either matches the repository's short name or starts with it followed by an underscore",
